...
func (s *StateDB) FinaliseWithConcrete(concretePrecompiles map[common.Address]interface{}, deleteEmptyObjects bool) {
...
func (s *StateDB) IntermediateRootWithConcrete(concretePrecompiles map[common.Address]interface{}, deleteEmptyObjects bool) common.Hash {
...
func (s *StateDB) CommitWithConcrete(concretePrecompiles map[common.Address]interface{}, block uint64, deleteEmptyObjects bool) (common.Hash, error) {
...
func (s *StateDB) Prepare(rules params.Rules, sender, coinbase common.Address, dst *common.Address, precompiles []common.Address, concretePrecompiles map[common.Address]interface{}, list types.AccessList) {
	if rules.IsBerlin {
