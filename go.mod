...
require (
	...
	github.com/therealbytes/concrete-native-precompiles v0.0.0-20230418163521-c266167d4956
	github.com/therealbytes/concrete-wasm-precompiles v0.0.0-20230000000000-000000000000
